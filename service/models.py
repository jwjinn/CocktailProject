...
class Userregister(models.Model):
    ...
    hadooplocation = models.CharField(db_column='hadoopLocation', max_length=50, blank=True, null=True)  # Field name made lowercase.
